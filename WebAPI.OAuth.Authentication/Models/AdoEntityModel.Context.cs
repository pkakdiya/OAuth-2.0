...
namespace WebAPI.OAuth.Authentication.Models
{
    using System;
    ...
    public partial class OAuthAPIEntities_API : DbContext
    {
        public OAuthAPIEntities_API()
            : base("name=OAuthAPIEntities_API")
        {
        }
